...
def openmeteo_7_day_call(url, lat, lon, block_csv = True, top_folder = 'locations'):
    """
    ...
    params = {
        "latitude": lat,
        "longitude": lon,
        "hourly": ["temperature_2m", "wind_speed_10m", "relative_humidity_2m", "precipitation_probability", "precipitation", "surface_pressure", "cloud_cover", "evapotranspiration", "shortwave_radiation", "wind_direction_10m"],
    }
    ...
    # Dictionary mapping variable names -> their hourly arrays
        ...
        for var, values in variables.items():
            ...
            csv_file = os.path.join(outdir, "{}N_{}W_{}.csv".format(lat, lon, var))
...
def full_grid_call(n, block_csv = True, top_folder = 'locations'):
    """
...
full_grid_call(5, False) #testing with a 5x5 grid!
